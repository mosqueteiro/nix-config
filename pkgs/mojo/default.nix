# Based on Niclas Overby's source-build recipe:
# https://github.com/overby-me/overby-me/tree/main/platform/nix/packages/mojo
#
# Copyright 2026 Niclas Overby and contributors to the original recipe.
# Modified for this repository on 2026-09-03.
...
let
  ...
  # in the cheap top-level derivation so packaging fixes do not rebuild LLVM.
